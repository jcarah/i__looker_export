...
class LookerHook(BaseHook):
    ...
    def __init__(self, looker_conn_id):
        self.looker_conn_id = looker_conn_id
        self.connection = self.get_connection(looker_conn_id)
        self.host = '{}:{}/api/3.0/'.format(self.connection.host,
...
# POST /scheduled_plans
    def run_scheduled_plan_once(self,body):
